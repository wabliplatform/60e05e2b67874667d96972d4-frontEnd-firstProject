...
(function(root, factory) {
  ...
  describe('Project', function() {
    ...
    it('should have the property projectWorkpackages (base name: "projectWorkpackages")', function() {
      // uncomment below and update the code to test the property projectWorkpackages
      //var instance = new TempApi.Project();
      //expect(instance).to.be();
    });
